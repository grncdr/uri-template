  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_uriTemplate() {
        ...
        var savedPos0 = pos;
        var result1 = [];
        var result5 = parse_nonexpression();
        if (result5 !== null) {
          var result3 = result5;
        } else {
      ...
      function parse_paramList() {
        ...
        var result2 = result1 !== null
          ? (function(hd, rst) { rst.unshift(hd); return rst; })(result1[0], result1[1])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_param() {
        ...
        var result2 = result1 !== null
          ? (function(chars, cut, listMarker) { return {
                name: chars.join(""),
                explode: listMarker,
                cut: cut
      ...
      function parse_substr() {
        ...
        var result2 = result1 !== null
          ? (function(digits) { return parseInt(digits.join('')) })(result1[1])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_nonexpression() {
        var cacheKey = 'nonexpression@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
